...
def test_mark_2nd_lvl_element():
    ...
    home_checkbox_mark = driver.find_element(By.XPATH,
                                             "//label[@for='tree-node-home']/span[@class='rct-checkbox']/*").get_attribute(
        "class")
    desktop_checkbox_mark = driver.find_element(By.XPATH,
                                                "//label[@for='tree-node-desktop']/span[@class='rct-checkbox']/*").get_attribute(
        "class")
...
def test_mark_single_element():
    ...
    office_private_checkbox = driver.find_element(By.XPATH, "//label[@for='tree-node-office']/../..//label[@for='tree-node-private']/span[@class='rct-checkbox']")
